...
KEYWORD_RESPONSE_MAP = {
    ('رابط المدينة', 'جروب المدينة', 'رابط المدينه'): ('🎯 جروب حلقات المدينة البعيدة', 'https://t.me/+evUItbGXkRU3YTE0'),
    ('المدينة منخفضة', 'المدينه منخفضه'): ('🔻جروب حلقات المدينة جودة منخفضة! ', 'https://t.me/+w5efATshnAphMGQ0'),
    ('رابط قطاع',): ('📦 جروب حلقات قطاع الطرق', 'https://t.me/+HYqMeQYROVkyZDU8'),
    ('رابط القضاء',): ('⚖️ جروب حلقات القضاء', 'https://t.me/+1YIyI0IqDasyZDQ0'),
    ('رابط طبيب القرية', 'رابط طبيب القريه'): ('🩺 جروب حلقات طبيب القرية', 'https://t.me/+lm_X8yn8eVw2OTE8'),
    ('رابط حلم اشرف',): ('🌙 جروب حلقات حلم اشرف', 'https://t.me/+-sOunO8YnMdiOTE0'),
    ('رابط ليلى', 'رابط ليلي'): ('👧 جروب حلقات ليلى', 'https://t.me/+1IYRMalAuTw4YTA0'),
    ('رابط العبقري', 'رابط العبقرى'): ('🧠 جروب حلقات العبقري', 'https://t.me/+k9XFpNcsreZlNWE8'),
    ('رابط القبعة', 'رابط القبعه', 'رابط القبعة السوداء', 'رابط القبعه السوداء'): ('🎩 جروب حلقات القبعة السوداء', 'https://t.me/+RnOqk1eJnR0yMDRk'),
}
