...
KEYWORD_RESPONSE_MAP = {
    ...
    ('رابط قضاء', 'رابط القضاء'): ('⚖️ جروب حلقات القضاء', 'https://t.me/+JEbOxizEd3k0Nzk0'),
    ('رابط طبيب', 'رابط طبيب القريه'): ('🩺 جروب حلقات طبيب القرية', 'https://t.me/+bmRQBbkjvP44MDk0'),
    ('رابط حلم اشرف',): ('🌙 جروب حلقات حلم اشرف', 'https://t.me/+GzWgt9-BWEs2M2Q0'),
    ('رابط ليلى', 'رابط ليلي'): ('👧 جروب حلقات ليلى', 'https://t.me/+6PEYPb3yEvRhNGY0'),
    ('رابط الغرفة', 'رابط الغرفه'): ('👫 جروب حلقات الغرفة المزدوجة', 'https://t.me/+rGwD7HFcFUI1MDJk'),
    ('رابط العبقري', 'رابط العبقرى'): ('🧠 جروب حلقات العبقري', 'https://t.me/+8DnE-JCX9eBkNjg0'),
    ('رابط القبعة', 'رابط القبعه', 'رابط القبعة السوداء', 'رابط القبعه السوداء'): ('🎩 جروب حلقات القبعة السوداء', 'https://t.me/+bk4ZQAy9oNAzYjlk'),
}
