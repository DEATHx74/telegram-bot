...
KEYWORD_RESPONSE_MAP = {
    ...
    ('جروب القضاء', 'رابط القضاء', 'رابط القضاء'): ('⚖️ جروب حلقات القضاء', 'https://t.me/+r1NxaRcAbgllNDU0'),
    ('رابط طبيب', 'جروب طبيب', 'رابط طبيب القريه'): ('🩺 جروب حلقات طبيب القرية', 'https://t.me/+SdEtq0ZWtS85OTBk'),
